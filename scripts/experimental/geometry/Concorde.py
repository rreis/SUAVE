...
def vehicle_setup():
    ...
    wing_section[0].span        = 6.15/(25.6/2.)*wing.spans.projected*.53 #for some reason, inner section doesn't use half-span
    ...
    wing.tip_origin = wing.origin+wing_section[2].tip_origin
