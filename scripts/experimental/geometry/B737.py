...
def vehicle_setup():
    ...
    wing_section[2].span        = (1-.963)*wing.spans.projected#*.5
    ...
    wing_section[2].tip_origin  = wing_rel_pos + wing_section[2].root_origin+wing_section[1].root_origin+wing_sectio[0].root_origin
