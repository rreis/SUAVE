...
def base_analysis(vehicle):
    ...
    filenames.Nastran_scratch_file = "conventional_opt.aeso"
    local_dir = os.getcwd()
...
def vehicle_setup():
    ...
    wing.origin                  = [13.61, fuselage.effective_diameter*.52, -1.27]
    ...
    wing_section[0].span        = .324*wing.spans.projected*.53 #for some reason, inner section doesn't use half-span
