...
#from SUAVE.Methods.Geometry.Two_Dimensional.Planform.compute_engine_geometry import compute_engine_geometry
...
#    
#    aircraft.import_from_suave(configs.base)


    
    
    #geomach_geometry(aircraft,'E190.stl')
...
def base_analysis(vehicle):
    ...
    SBW_wing.nastran_path ="/opt/MSC/NASTRAN/bin/msc20131 nastran" #"nast20140"
