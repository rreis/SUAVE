...
def geometry_generation(aircraft,geomach_structural_mesh,structural_surface_grid_points_file,stl_mesh_filename):
    ...
    if(aircraft.type=='Conventional'):
        ...
        print 'aircraft.main_wing[1].main_wing_section[0].root_origin[0] =', aircraft.main_wing[1].main_wing_section[0].root_origin[0]#44.0
        print 'aircraft.main_wing[1].main_wing_section[0].root_origin[1] =', aircraft.main_wing[1].main_wing_section[0].root_origin[1]#0.
        print 'aircraft.main_wing[1].main_wing_section[0].root_origin[2] =', aircraft.main_wing[1].main_wing_section[0].root_origin[2]#1.3
