...
def geometry_generation(aircraft,geomach_structural_mesh,structural_surface_grid_points_file,stl_mesh_filename):
    ...
    if(aircraft.type=='Conventional'):
        ...
        print 'aircraft.main_wing[0].main_wing_section[0].tip_origin[2]  =', aircraft.main_wing[0].main_wing_section[0].tip_origin[2]
                                                       #                                                         #            
        print 'aircraft.main_wing[0].main_wing_section[1].tip_origin[0]  =', aircraft.main_wing[0].main_wing_section[1].tip_origin[0]
        print 'aircraft.main_wing[0].main_wing_section[1].tip_origin[1]  =', aircraft.main_wing[0].main_wing_section[1].tip_origin[1]
        print 'aircraft.main_wing[0].main_wing_section[1].tip_origin[2]  =', aircraft.main_wing[0].main_wing_section[1].tip_origin[2]
                                                                                               
        print 'aircraft.main_wing[0].main_wing_section[0].root_origin[0] =', aircraft.main_wing[0].main_wing_section[0].root_origin[0]#44.0
        print 'aircraft.main_wing[0].main_wing_section[0].root_origin[1] =', aircraft.main_wing[0].main_wing_section[0].root_origin[1]#0.
        print 'aircraft.main_wing[0].main_wing_section[0].root_origin[2] =', aircraft.main_wing[0].main_wing_section[0].root_origin[2]#1.3
                                                                                                                                      
        print 'aircraft.main_wing[1].main_wing_section[0].tip_origin[0]  =', aircraft.main_wing[1].main_wing_section[0].tip_origin[0] #-aircraft.main_wing[1].main_wing_section[0].root_origin[0] #6.0
        print 'aircraft.main_wing[1].main_wing_section[0].tip_origin[1]  =', aircraft.main_wing[1].main_wing_section[0].tip_origin[1] #-aircraft.main_wing[1].main_wing_section[0].root_origin[1] #1.4
        print 'aircraft.main_wing[1].main_wing_section[0].tip_origin[2]  =', aircraft.main_wing[1].main_wing_section[0].tip_origin[2] #-aircraft.main_wing[1].main_wing_section[0].root_origin[2] #8.0
                                                         #                                                             #            
        print 'aircraft.main_wing[1].main_wing_section[1].tip_origin[0]  =', aircraft.main_wing[1].main_wing_section[1].tip_origin[0] #-aircraft.main_wing[1].main_wing_section[1].root_origin[0] #6.0
        print 'aircraft.main_wing[1].main_wing_section[1].tip_origin[1]  =', aircraft.main_wing[1].main_wing_section[1].tip_origin[1] #-aircraft.main_wing[1].main_wing_section[1].root_origin[1] #1.4
        print 'aircraft.main_wing[1].main_wing_section[1].tip_origin[2]  =', aircraft.main_wing[1].main_wing_section[1].tip_origin[2] #-aircraft.main_wing[1].main_wing_section[1].root_origin[2] #8.0
