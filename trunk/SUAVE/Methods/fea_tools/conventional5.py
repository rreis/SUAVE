...
#        rtail['ogn'].params[''].val([0.25,0,0])
    ...
    def _set_bspline_options(self):
        ...
        comps['fuse'].faces['rgt'].set_option('num_cp', 'v', [4,6,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,6,4])
        comps['fuse'].faces['rgt'].set_option('num_pt', 'v', [120,48,48,48,48,180,48,120,48,48,210,48,120,48,48,48,48,180,48,120,48,48,210,48], both=False)
