...
def write_tecplot_file(pointlist,elemlist,tecplot_file_orig,tecplot_file_deformed,npoint,nelem):
...
#
#    for i in range(0,npoint):
#        mesh_def.write(format(pointlist[i].x1+pointlist[i].t1))
#        mesh_def.write("\n")
#
#
#    for i in range(0,npoint):
#        mesh_def.write(format(pointlist[i].x2+pointlist[i].t2))
#        mesh_def.write("\n")
#
#    for i in range(0,npoint):
#        mesh_def.write(format(pointlist[i].x3+pointlist[i].t3))
#        mesh_def.write("\n")
#
#    for iNode in range(0,npoint):
...
#
#    for i in range(0,nelem):
#        mesh_def.write(format(elemlist[i].g1))
#        mesh_def.write("  ")
#        mesh_def.write(format(elemlist[i].g2))
#        mesh_def.write("  ")
#        mesh_def.write(format(elemlist[i].g3))
#        mesh_def.write("  ")
#        mesh_def.write(format(elemlist[i].g3))
#        mesh_def.write("\n")
#
