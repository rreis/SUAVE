...
def write_tecplot_file(pointlist,elemlist,tecplot_file_orig,npoint,nelem):
    ...
    mesh_def.write("VARIABLES = \"x\"  \"y\"  \"z\" \"in_stress_von_mises\" \"fin_stress_von_mises\" \"force x\" \"force y\" \"force z\" \"pressure\" \"thickness\" \"test\" \"el_thickness\" ")
    mesh_def.write("\n")
    mesh_def.write("\n")
    mesh_def.write("ZONE")
    mesh_def.write("\n")
    ...
    mesh_def.write("\n")
    mesh_def.write("VarLocation=([10-12]=CellCentered)")
    mesh_def.write("\n")
    ...
    for i in range(0,nelem):
        mesh_def.write(format(elemlist[i].pressure))
        if((i%4 == 0) and (i != 0)):
            mesh_def.write("\n")
        else:
            mesh_def.write("\t")
    ...
    for i in range(0,nelem):
        mesh_def.write(format(elemlist[i].thickness))
        if((i%4 == 0) and (i != 0)):
            mesh_def.write("\n")
        else:
            mesh_def.write("\t")
