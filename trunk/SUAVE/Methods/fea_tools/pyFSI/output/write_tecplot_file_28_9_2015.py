...
def write_tecplot_file(pointlist,elemlist,tecplot_file_orig,npoint,nelem):
    ...
    mesh_def.write("VARIABLES = \"x\"  \"y\"  \"z\" \"in_stress_von_mises\" \"fin_stress_von_mises\" \"force x\" \"force y\" \"force z\" \"pressure\" \"thickness\" \"test\" ")
    mesh_def.write("\n")
    mesh_def.write("\n")
    mesh_def.write("ZONE")
    mesh_def.write("\n")
    ...
    mesh_def.write("\n")
    mesh_def.write("VarLocation=([10-11]=CellCentered)")
    mesh_def.write("\n")
