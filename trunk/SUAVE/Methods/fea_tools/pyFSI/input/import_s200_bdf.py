...
from SUAVE.Methods.fea_tools.pyFSI.input.read_bdf_file_force import read_bdf_file_force


def import_s200_bdf(input_bdf,s200):
    ...
    s200.no_of_elements = no_of_elements_ud
    ...
    no_of_elements = no_of_elements_ud
