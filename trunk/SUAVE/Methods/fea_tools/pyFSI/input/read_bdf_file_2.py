...
def read_bdf_file(mesh_filename,scaling_factor):
...
#            if (pointlist[point_count].x[0] <= 0.):#and(pointlist[point_count].x[0] >= -0.5):
#                print pointlist[point_count].x[0], pointlist[point_count].x[1],pointlist[point_count].x[2]
        ...
        if (line[0:6]=='CQUAD4'):
            ...
            elemlist[element_count].g = [0.,0.,0.,0.]
...
#            material_list[element_count].rho=element_break[41:48]
        ...
        if (line[0:3]=='SPC'):
            ...
            constrained_grid_point_list[constraint_count].g[0]=int(line[17:24])
